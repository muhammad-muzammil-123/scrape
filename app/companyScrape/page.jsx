  ...
  return (
    ...
    <header className=" ">
      ...
      <nav className={`md:hidden ${isOpen ? 'block' : 'hidden'} bg-gray-700`}>
        <Link href="#home" className="block px-4 py-2 text-white transition-all hover:bg-gray-300">
          Home
        </Link>
        <Link href="#about"    className="block px-4 py-2 text-white transition-all hover:bg-gray-300">
       About
        </Link>
        <Link href="#services"      className="block px-4 py-2 text-white transition-all hover:bg-gray-300">
     Services
        </Link>
        <Link href="#contact" className="block px-4 py-2 text-white transition-all hover:bg-gray-300">
           Contact
        </Link>
...
<h1 className="text-5xl text-white mt-20 text-center">Would you like to company scraping ?</h1>
...
<h2 className="text-5xl ">
  hello, What's company scrape
</h2>
<p className="text-xl mt-3    leading-10 tracking-widest">
