    ...
    return(
        ...
        <nav className={`md:hidden ${isOpen ? 'block' : 'hidden'} bg-gray-700`}>
         ...
         user scraping
          ...
          <a
           href="./companyScrape"      className="block px-4 py-2 text-white transition-all hover:bg-gray-300">
    company scraping
          </a>
          ...
          {/* <h1 className="text-5xl text-center mb-8 text-blue-500 font-bold"  ></h1> */}
            ...
            <form >
              ...
              <div className="fb-submit">
                <button type="submit" className="mt-5 mb-4  py-4 px-5 bg-violet-500 transition-all text-white font-semibold rounded-md shadow-md hover:bg-purple-500">Login</button>
                <p>If you don't have acount</p>
              </div>
              <hr />
           <a href="/signup">
           <button className=" mt-5 mb-4  ml-20  py-4 px-5 bg-violet-500 transition-all text-white font-semibold rounded-md shadow-md hover:bg-purple-500">
                Create new account
              </button>
              </a>
            </form>
